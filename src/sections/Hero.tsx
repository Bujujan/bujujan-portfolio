...
export const HeroSection = () => {
    return (
        <div className="flex flex-col flex-wrap relative items-center pt-52 pb-16 z-0">
            <div className="absolute -inset-0 -z-30 opacity-10 overflow-hidden" style={{backgroundImage: `url(${grainImage.src})`}}></div>
            <div className="container flex md:w-[65%] w-full h-full ">
                <div className="flex flex-row w-full gap-6">

                    <div className="grid grid-rows-2 gap-12 px-7 py-7 box rounded-3xl w-[40%] h-72">
                        ...
                        <div>
                            <p className="pb-4 w-[90%]">I am a Software Engineering student, Web developer, I specialise in Front-end,
                                also a Web Designer.
                            </p>
                            <div className="flex items-center gap-4 box bg-black/10 w-[53%] py-1 px-3">
                    ...
                    <div className="flex flex-col w-[60%] gap-4">
                        <div className="flex justify-center w-full box h-14 items-center overflow-hidden">
                            ...
                            <ul className="flex w-[90%] gap-14 scroll-triggered">
                        ...
                        <div className="flex gap-4">
                            <div className="h-[215px] w-72 box overflow-hidden">
                                <img src={rabat.src} alt="" className="object-cover w-full h-full rounded-3xl" />
                            </div>
                            <div className="w-[60%] flex flex-col gap-5">
                                <div className="box size-24 w-full flex justify-between items-center px-16">
                                    <div>
            ...
            <div className="flex w-[65%] py-4 overflow-hidden">
                <div className="flex flex-col gap-4 w-[50%]">
                    <div className="flex gap-4">
                        <div className="flex justify-center items-center box size-40 w-[230px]">
                    ...
                    <div>
                        <div className="box size-40 center w-[95%]">
                ...
                <div className="box w-[59%] flex flex-col p-8 gap-4">
